#!/usr/bin/python3
"""Module that quries the Reddit API and returns a list containing the
titles of all hot article for a given subreddit."""
import requests


def recurse(subreddit, hot_list=[], n=0, after=None):
    """ querie the Reddit API and returns a list containing the titles of
